...
function GetDoubledAverage(z: matrix): double; external 'Project1.dll';



function GetSumOfPositiveNumberInColumn(a: array of Integer): Integer; external 'Project1.dll';


function GetMaxInMatrix(z: matrix): Integer;      external 'Project1.dll';
...
procedure cpy(var a1, a2: array of Integer; const n: Integer);   external 'Project1.dll';
